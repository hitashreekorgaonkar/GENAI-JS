    ...
    messages: [
      {
        role: "system",
        content:
          "You are an assistant that rewrites HTML/CSS/JS so it works fully offline. Fix all broken asset links, rewrite absolute URLs to relative, and clean the code.",
      },
